"""
MSP numeric constants as simple Python constants.
Import e.g. `from msp_constants import MSP_ATTITUDE`.
"""
# Basic MSP v1 codes
MSP_API_VERSION = 1
MSP_FC_VARIANT = 2
...
# Example MSPv2 / INAV extended codes (kept as constants too)
